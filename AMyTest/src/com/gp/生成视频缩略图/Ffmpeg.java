...
/**
 * @author 高攀
 * @上午10:47:46 生成视频缩略图 1、下载 ffmpeg
 */
public class Ffmpeg {
	...
	public static void main(String[] args) {
		...
		// 视频文件
		String videoRealPath = "D:" + File.separator
				+ "ffmpeg\\mybat\\video\\test.mp4";
		// 截图的路径（输出路径）
		String imageRealPath = "D:\\ffmpeg\\mybat\\mytest\\test.jpg";

		// 方法三：调用系统中的可执行程序调用ffmpeg 提取视屏缩略图
		List<String> commend = new ArrayList<String>();
		commend.add("D:\\ffmpeg\\bin\\ffmpeg.exe"); // 找到exe执行程序
		commend.add("-i");
